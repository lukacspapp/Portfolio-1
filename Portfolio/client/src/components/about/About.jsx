...
import node from '../../image/Node.js_logo.svg'
    ...
    <div className='about' id='a-about'>
      <div className="a-left">
        <div className="a-card">
          ...
          <div className="c-info-item">
            <img className='icon' alt='mdb' src='https://upload.wikimedia.org/wikipedia/commons/9/93/MongoDB_Logo.svg'></img>
          </div>
          <div className="c-info-item">
            <img className='python' alt='python' src='https://upload.wikimedia.org/wikipedia/commons/c/c3/Python-logo-notext.svg'></img>
          </div>
          <div className="c-info-item">
            <img className='icon' alt='django' src='https://upload.wikimedia.org/wikipedia/commons/7/75/Django_logo.svg'></img>
          </div>
          <div className="c-info-item">
          ...
          <div className="c-info-item">
            <img className='icon' alt='mongoose' src='https://camo.githubusercontent.com/7c669e872b214571ae0b5097e8d3db369225a806dc2ce9a436cde3497164310c/687474703a2f2f6d6f6e676f64622d746f6f6c732e636f6d2f696d672f6d6f6e676f6f73652e706e67'></img>
          </div>
          <div className="c-info-item">
